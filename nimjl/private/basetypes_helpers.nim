...
{.used.}
##Types
type jl_value *{.importc: "jl_value_t", header: juliaHeader, pure.} = object
type jl_array *{.importc: "jl_array_t", header: juliaHeader, pure.} = object
type jl_func *{.importc: "jl_function_t", header: juliaHeader, pure.} = object
type jl_module *{.importc: "jl_module_t", header: juliaHeader, pure.} = object
type jl_datatype*{.importc: "jl_datatype_t", header: juliaHeader, pure.} = object
type jl_sym*{.importc: "jl_sym_t", header: juliaHeader, pure.} = object
