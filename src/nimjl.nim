...
proc nimjl_call2*(function: nimjl_func, arg1: pointer, arg2: pointer): pointer {.importc.}
...
proc nimjl_reshape_array*(atype: nimjl_value, data: nimjl_array, dims: nimjl_value): nimjl_array {.importc.}

proc nimjl_ptr_to_array_1d*(atype: nimjl_value, data: pointer, nel: csize_t, own_buffer: cint): nimjl_array {.importc.}

proc nimjl_ptr_to_array*(atype: nimjl_value, data: pointer, dims: nimjl_value, own_buffer: cint): nimjl_array {.importc.}

proc nimjl_alloc_array_1d*(atype: nimjl_value, nr: csize_t): nimjl_array {.importc.}

proc nimjl_alloc_array_2d*(atype: nimjl_value, nr: csize_t, nc: csize_t): nimjl_array {.importc.}

proc nimjl_alloc_array_3d*(atype: nimjl_value, nr: csize_t, nc: csize_t, z: csize_t): nimjl_array {.importc.}
